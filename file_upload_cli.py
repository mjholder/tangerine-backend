...
def upload_files(directory_path, agent_id):
    ...
    files.extend(glob.glob(os.path.join(directory_path, '**', '*.txt'), recursive=True))
    ...
    for i in range(num_batches):
        ...
        url = f'http://localhost:5000/agents/{agent_id}/document_upload'
...
if __name__ == "__main__":
    ...
    parser.add_argument("directory_path", type=str, help="Path to the directory containing .rst, .md, and .txt files.")
